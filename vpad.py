...
main.title('Kartik text editor')
main.wm_iconbitmap('icon.ico')

####################### MAIN MENU ######################################################

main_menu=tk.Menu(main)
...
def find_func(event=None):
    ...
    ##frame
    find_frame=ttk.LabelFrame(find_dialog,text='Find/Reaplace')
...
edit.add_command(label='Copy',image=copy_icon,compound=tk.LEFT,accelerator='Ctrl+',command=lambda:text_editor.event_generate("<Control c>"))
...
main.bind("<Control-q>",exit_func)
main.bind("<Control-f>",find_func)
